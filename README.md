🦠 Malaria Detection Using Deep Learning Project Overview
...
📂 Project Structure 
Malaria-Detection-Using-Deep-Learning │ ├── dataset │ ├── train │ │ ├── Parasitized │ │ └── Uninfected │ │ │ └── validation │ ├── Parasitized │ └── Uninfected │ ├── static │ └── uploads │ ├── templates │ └── index.html │ ├── visualize.py ├── augmentation.py ├── model_building.py ├── train_model.py ├── evaluate_model.py │ ├── app.py │ ├── malaria_model.h5 │ ├── requirements.txt ├── README.md └── .gitignore 
...
2️⃣ Click Predict
3️⃣ View whether the cell is Parasitized or Uninfected
